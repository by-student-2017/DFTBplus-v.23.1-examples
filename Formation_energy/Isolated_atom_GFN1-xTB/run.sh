...
echo "# Atom, Total Energy [eV], Extrapolated to 0 K [eV], Total Mermin free energy [eV], Force related energy [eV]" > isolated_atom_energy_GFN1-xTB.txt
...
do
  ...
  #---------------
  echo "${atom}, ${TE}, ${ETE}, ${TMFE}, ${FRE}" >> isolated_atom_energy_GFN1-xTB.txt
  #------------------------------------------------------------------------
