...
## Note ######################################
- Note 1: On a normal PC, it is faster to calculate 1k points by making each axis a supercell of 8 angstroms or more than calculating several k points with a small cell.
