...
- Note 5: Before performing MD calculations for the diffusion coefficient and MSD, it is best to clarify the calculation conditions for the Broyden method. Among them, choose one that is close to the default value.
